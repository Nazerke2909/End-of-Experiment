...
public class HubInputHandler {
    ...
    public ClickResult handleTouch() {
        ...
        System.out.println("CLICK at: x=" + String.format("%.1f", touch.x) + ", y=" + String.format("%.1f", touch.y));
        ...
        for (int i = 0; i < LEVELS_COUNT; i++) {
            ...
            System.out.println("  Level " + (i+1) + ": x=[" + String.format("%.1f", x1) + "-" + String.format("%.1f", x2) + "], y=[" + String.format("%.1f", y1) + "-" + String.format("%.1f", y2) + "], inX=" + inX + ", inY=" + inY + ", unlocked=" + unlocked);
            if (unlocked && inX && inY) {
                System.out.println("  -> LEVEL " + (i+1));
                return new ClickResult(ClickType.LEVEL, i + 1);
            }
        }
